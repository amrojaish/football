...
==========================================
يفتح كل PNG بمجلد الشعار الجديد ويطبع: الاسم، الصيغة، وضع الألوان،
المقاس، ولون البكسل (2,2) — للتأكد أن كل ملف يطابق اسمه قبل أي نقل
فعلي. لا يعدّل أو ينقل أي شيء.

الاستعمال:
    python verify_new_icons.py [مسار المجلد]
...
DEFAULT_DIR = r"C:\Users\User\logo_new"
DIR = Path(sys.argv[1]) if len(sys.argv) > 1 else Path(DEFAULT_DIR)

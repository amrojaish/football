...
STEPS += [
    ...
    # ⚠️ **معطَّل مؤقتاً — 6 سبتمبر 2026 (بند مفتوح 26 بالـREADME).**
    #    apply_player_merges.py وُسِّع نفس اليوم ليكتب 774 زوجاً
    #    (25,735 سجلاً بـplayer_en+assist_en) بدل الزوج الواحد
    #    النشط سابقاً — فحص لم يكتمل بعد لأثره على player_slug.py/
    #    make_players.py (صفحات يتيمة/روابط مكسورة محتملة، نفس
    #    نمط درس 22). **إعادة تفعيله جزء إلزامي من جلسة الكتابة
    #    القادمة** — تركه معطَّلاً بلا قرار يعني توقّف دمج أسماء
    #    اللاعبين كلياً، لا حلاً دائماً.
